        ...
        return (
            <>
                <ButtonOtus variant='info' className={styles.cartButtonWithIncrement}>
                        ...
                        <input type="text" name='quantity' className={styles.inputValue} value={props.count} onChange={(e: ChangeEvent<HTMLInputElement>) => { props.setCount(Number((e.target.value).replace(/[^\d]/g, ''))) }} />
