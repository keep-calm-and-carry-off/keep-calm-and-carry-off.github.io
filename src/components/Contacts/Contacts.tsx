...
import { logout } from 'src/stores/globalStore/globalStore';
...
export const Contacts: FC = () => {
    ...
    const isAuth = useSelector(authController.getAuthStatus)
                        ...
                        !isAuth ?
                            <>
                                <Link to='?showModal=true&content=auth' className='d-flex text-decoration-none'>
                                    ...
                                    <AiOutlineUser className={styles.settings} style={{ marginRight: '8px' }} /></Link>
                            </>
                            :
                            <>
